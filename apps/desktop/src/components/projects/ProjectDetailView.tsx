...
import { 
    ...
    FileText, Activity, Layers, ChevronRight, File, Folder as FolderIcon
} from 'lucide-react'
...
import { fetchProjectTree, fetchProjectGitHistory, refreshProject } from '@/lib/orchestra-client'
    ...
    return (
        <div className="flex flex-col h-full bg-background/20 overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-8 min-h-0">
                ...
                {activeTab === 'tasks' && (
                    <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                        <div className="bg-background/20 rounded-2xl border border-white/5 p-6 backdrop-blur-sm">
                            <KanbanBoard
                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                        {loadingTab ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-20 opacity-40">
                                ...
                                <p className="text-sm font-bold uppercase tracking-widest">No files indexed</p>
                            </div>
                        ) : (
                            <div className="bg-background/40 border border-white/10 rounded-xl overflow-hidden shadow-inner">
                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                        {loadingTab ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-20 opacity-40">
                                ...
                                <p className="text-sm font-bold uppercase tracking-widest">No git history available</p>
                            </div>
                        ) : (
                            <div className="space-y-4">
                                {gitHistory.map((commit, idx) => (
                                    <div key={idx} className="bg-background/40 border border-white/10 rounded-xl p-4 flex gap-4 items-start group hover:border-primary/30 transition-colors">
                                        <div className="mt-1">
